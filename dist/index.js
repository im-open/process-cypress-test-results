      ...
      await octokit
        ...
        .then(comments => {
          if (comments.length === 0) {
            ...
            if (existingComment) {
              core2.info(
                `An existing comment (${existingComment.id}) was found and will be updated.`
              );
        ...
        .catch(error => {
          core2.info(
            `Failed to list PR comments. Error code: ${error.message}.  A new comment will be created.`
          );
        });
      core2.info(
        `Finished getting comments for PR #${github.context.payload.pull_request.number}.`
      );
      return commentId;
    }
  ...
  'node_modules/date-fns-tz/toDate/index.js'(exports2, module2) {
    ...
    function toDate(argument, dirtyOptions) {
      ...
      if (date) {
        ...
        if (dateStrings.timezone || options.timeZone) {
          offset = (0, _tzParseTimezone.default)(
    ...
    function parseTime(timeString) {
      ...
      if (token2) {
        ...
        return (
          (hours % 24) * MILLISECONDS_IN_HOUR + minutes * MILLISECONDS_IN_MINUTE + seconds * 1e3
        );
      }
      return null;
    }
      ...
      if (matches) {
        ...
        formatStr = matches.reduce(function (result, token2) {
          return token2[0] === "'"
            ...
            : result.replace(
                token2,
                "'" + _formatters.default[token2[0]](date, token2, null, options) + "'"
              );
        }, formatStr);
      }
...
var require_formatDistance2 = __commonJS({
  'node_modules/date-fns/formatDistance/index.js'(exports2, module2) {
    ...
    function formatDistance(dirtyDate, dirtyBaseDate) {
      ...
      var offsetInSeconds =
        ((0, _index7.default)(dateRight) - (0, _index7.default)(dateLeft)) / 1e3;
    ...
    if (markupData.length > characterLimit) {
      ...
      if (markupData.length > 65535) {
        ...
        markupData =
          ...
          '<br/>...Truncated due to character limit.';
      }
    } else {
